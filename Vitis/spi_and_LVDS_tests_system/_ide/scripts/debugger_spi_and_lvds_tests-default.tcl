...
# Path of this script: /run/media/6TB/gitrepos/Mac-PhD/Vitis_Workspace/spi_and_LVDS_tests_system/_ide/scripts/debugger_spi_and_lvds_tests-default.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source /run/media/6TB/gitrepos/Mac-PhD/Vitis_Workspace/spi_and_LVDS_tests_system/_ide/scripts/debugger_spi_and_lvds_tests-default.tcl
# 
