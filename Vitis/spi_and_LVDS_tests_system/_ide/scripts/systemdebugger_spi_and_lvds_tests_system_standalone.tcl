...
# Path of this script: /run/media/6TB/gitrepos/Mac-PhD/Vitis_Workspace/spi_and_LVDS_tests_system/_ide/scripts/systemdebugger_spi_and_lvds_tests_system_standalone.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source /run/media/6TB/gitrepos/Mac-PhD/Vitis_Workspace/spi_and_LVDS_tests_system/_ide/scripts/systemdebugger_spi_and_lvds_tests_system_standalone.tcl
# 
