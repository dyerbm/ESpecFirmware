...
HD_PWD='C:/Users/soup/Documents/ESpecFirmware/Verilog/SPI_Tests/SPI_Tests.runs/top_LED_Visualizer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_LED_Visualizer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_LED_Visualizer_0_0.tcl
