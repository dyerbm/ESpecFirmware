...
HD_PWD='C:/Users/soup/Documents/ESpecFirmware/Verilog/SPI_Tests/SPI_Tests.runs/top_selectio_wiz_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_selectio_wiz_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_selectio_wiz_0_1.tcl
