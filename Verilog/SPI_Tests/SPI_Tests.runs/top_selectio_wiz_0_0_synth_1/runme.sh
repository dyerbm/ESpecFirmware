...
HD_PWD='/home/dyerbm/Documents/Mac-PhD/Verilog-Tests/SPI_Tests/SPI_Tests.runs/top_selectio_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_selectio_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_selectio_wiz_0_0.tcl
